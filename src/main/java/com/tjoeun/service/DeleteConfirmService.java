...
public class DeleteConfirmService implements TemplateService {
	...
	public void execute(Model model) {
		...
		System.out.println("DeleteConfirmService 실행");
...
//		System.out.println("DeleteConfirmService 클래스의: " + userID1);
		
		AbstractApplicationContext ctx = new GenericXmlApplicationContext("classpath:applicationCTX.xml");
		UserInfoDAO userInfoDAO = ctx.getBean("userInfoDAO", UserInfoDAO.class);
		
		userInfoDAO.DeleteConfirm(userID,userPassword,userID1);
