...
public class loginService implements TemplateService {
...
//		System.out.println(userPassword);
		...
		userInfoDAO.loginCheck(userID, userPassword);
		
		model.addAttribute("loginCheck",userInfoDAO.loginCheck(userID, userPassword));
