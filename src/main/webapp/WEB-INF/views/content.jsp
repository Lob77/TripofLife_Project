		...
		<div class="container px-4 px-lg-5">
			...
			<form action="logout">
				<button class="btn btn-outline-dark" type="submit"
					style="margin: 10px">
					<a href="./login" style="text-decoration: none; color: black;">로그아웃</a>
				</button>
			</form>
		</div>
	</nav>	 
		...
		<div class="container" role="main">
			...
			<form action="contentOK" method="post">
				...
				<div class="mb-3">
					...
					<textarea class="form-control" rows="20" name="content" id="content" placeholder="내용을 입력해 주세요" style="resize: none;"></textarea>
				</div>
