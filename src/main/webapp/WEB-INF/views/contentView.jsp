	...
	<article>
		...
		<form action="?" method="post">
				...
				<div style="margin-top : 20px">
					...
					<button type="button" tabindex="2" class="btn btn-outline-dark" onclick="reservation()">찜하기</button>	
					<input type="button" value="삭제하기" tabindex="2" class="btn btn-outline-dark" 
						onclick="location.href = 'DeleteCheck?idx=${co.idx}&currentPage=${currentPage}&userID1=${co.userID}'"/>	<!-- 삭제권한부여와 관련해 변경한 부분 -->
					<input type="button" value="수정하기" tabindex="2" class="btn btn-outline-dark" 
						onclick="location.href = 'contentViewUpdate?idx=${co.idx}&currentPage=${currentPage}'"/><!-- 글 수정 관련해 변경한 부분 -->
				</div>
		...
		<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				<tr>
					<td>
						...
						<textarea class="form-control" rows="3" name="userComment" id="userComment" placeholder="내용을 입력해 주세요" style="resize: none;" ></textarea>
						<input class="btn btn-sm btn-primary" type="button" value="댓글입력" onclick="insertComment()" style="float: right; margin: 3px;"/>
					</td>
				</tr>
		</table>
	</div>
