		...
		<div class="container px-4 px-lg-5">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
					<li class="btn btn-light"><a class="nav-link active"
						aria-current="page" href="./IntroPage">홈페이지 소개</a></li>
					<li class="btn btn-light"><a class="nav-link" href="./list">여행지
							후기게시판</a></li>
	...
	<div class="section wrapper">
		<div class="section1" style="text-align: center;">
			<a href="https://korean.visitseoul.net/map-guide-book">
				<div class="Mainbox"
					style="width: 350px; height: 200px; display: inline-block; margin: 50px;">
					<img id="mainPics" src="resources/images/guide.jpg"
						class="d-block w-100">
				...
				<div class="Mainbox"
					style="width: 350px; height: 200px; display: inline-block; margin: 50px;">
					<img id="mainPics" src="resources/images/review.jpg"
						class="d-block w-100">
		...
		<div class="section2" style="text-align: center;">
			...
			<div class="Mainbox"
				style="width: 350px; height: 200px; display: inline-block; margin: 25px; margin-top: 0px; margin-bottom: 50px;">
				<img id="mainPics" src="resources/images/hotel.jpg"
					class="d-block w-100">
				<div class="MainboxText">숙소 가격 비교하러 가기</div>
			</div>
			</a> <a href="https://sky.interpark.com">
				<div class="Mainbox"
					style="width: 350px; height: 200px; display: inline-block; margin: 25px; margin-top: 0px; margin-bottom: 50px;">
					<img id="mainPics" src="resources/images/ticket.jpg"
						class="d-block w-100">
				...
				<div class="Mainbox"
					style="width: 350px; height: 200px; display: inline-block; margin: 25px; margin-top: 0px; margin-bottom: 50px;">
					<img id="mainPics" src="resources/images/introduce.jpg"
						class="d-block w-100">
